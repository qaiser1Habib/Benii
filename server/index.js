...
app.use("/v1/blogs", require("./routes/blogs.js"));
app.use("/v1/resources", require("./routes/resources.js"));
app.use("/v1/services", require("./routes/services.js"));
...
app.use("/v1/clients", require("./routes/clients.js"));
app.use("/v1/payments", require("./routes/payments.js"));
app.use("/v1/appointments", require("./routes/appointments.js"));
app.use("/v1/chats", require("./routes/chat.js"));
app.use("/v1/questions", require("./routes/question.js"));
